...
### Managing and editing configuration
...
* dataverse_api_token:  "", The personalized dataverse instance token generated by the user of the script should be supplied
...
It is recommended that you use a virtual environment to manage dependencies for this repository.
...
Windows Option #1: PowerShell

```powershell
.\.venv\Scripts\Activate.ps1
```

Windows Option #2: Command Prompt (cmd)
...
| Familiarity | Commonly used, familiar to many | Newer tool, growing adoption |
